...
//         {/* Logo */}
//         <div className="relative w-40 h-12"> {/* Adjust width and height as needed */}
//           <Image
//             src="/logo.png"
//             alt="Manal Abed Logo"
//             fill
...
//       {/* Hero Section */}
// <section className="relative py-12 md:py-20 px-4 bg-center bg-no-repeat" style={{ backgroundImage: "url('/div.png')" }}>
...
//           Reliable <span className="text-[#ff0000]">Scaffolding</span>
//           <br />
//           Solutions
//         </h1>
//         <p className="text-[#9ca3af] text-base md:text-lg mb-6 md:mb-8 max-w-md mx-auto lg:mx-0">
//           Supplying durable and safe scaffolding materials for your projects. Premium quality that meets
//           international safety standards.
//         </p>
//         <Button className="bg-[#ff0000] hover:bg-[#ff0000]/90 text-white px-6 md:px-8 py-2 md:py-3 text-base md:text-lg w-full sm:w-auto">
...
//       {/* About Section */}
//       <section className="bg-[#1f2937] py-12 md:py-16 px-4">
...
//             <p className="text-[#9ca3af] text-sm md:text-base">Visit our facility or find us on the map</p>
//           </div>

//           <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-start">
          
//             <div className="relative">
//               <div className="bg-[#1f2937] rounded-lg overflow-hidden h-64 md:h-80 lg:h-96">
//                 <iframe
//                   src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3608.7326!2d55.2708!3d25.2048!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43496ad9c645%3A0xbde66e1147b67d!2sDubai%20-%20United%20Arab%20Emirates!5e0!3m2!1sen!2s!4v1635000000000!5m2!1sen!2s"
//                   width="100%"
//                   height="100%"
//                   style={{ border: 0 }}
//                   allowFullScreen
...
//               <div>
//                 <h3 className="text-xl md:text-2xl font-bold text-white mb-6">Visit Our Facility</h3>
...
//                       <div className="text-[#9ca3af] text-sm md:text-base space-y-1">
...
//                 <Button className="bg-[#ff0000] hover:bg-[#ff0000]/90 text-white px-6 py-2 w-full sm:w-auto">
//                   Get Directions
//                 </Button>
//               </div>
//             </div>
...
//               <h3 className="text-lg md:text-xl font-bold text-white mb-4">Manal Abed</h3>
